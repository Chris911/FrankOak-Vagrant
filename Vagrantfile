...
Vagrant.configure("2") do |config|
    config.vm.define :laravel4 do |lv4_config|
        ...
        lv4_config.vm.hostname = "FrankOak-Dev"
        lv4_config.vm.synced_folder "www", "/var/www", {:mount_options => ['dmode=777','fmode=777']}
        lv4_config.vm.provision :shell, :inline => "echo \"Canada/Eastern\" | sudo tee /etc/timezone && dpkg-reconfigure --frontend noninteractive tzdata"
